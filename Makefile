...
EMCC_FLAGS:= -s EXPORTED_FUNCTIONS='["_testcallback","_add2","_animationFrame","_malloc","_main"]' -s EXPORTED_RUNTIME_METHODS='["ccall", "cwrap"]' -s ERROR_ON_UNDEFINED_SYMBOLS=0 
#-s SIDE_MODULE=1
#-s STANDALONE_WASM=1
#-s MODULARIZE
